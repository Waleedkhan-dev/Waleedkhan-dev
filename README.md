Absolutely! I can help you update your GitHub README to include **Next.js**, **TypeScript**, and **Supabase** in a clean and professional way. Here's the updated version:

---

# 💫 About Me:

👋 Hi there! I'm **Waleed Khan**, a passionate **Full Stack Developer** with over 2 years of experience in building dynamic and responsive web applications using **MERN** stack and modern technologies like **Next.js** and **TypeScript**.

I specialize in:

* ⚛️ **Frontend**: React JS, Next.js, TypeScript, JavaScript, HTML5, CSS3, Tailwind CSS, Bootstrap
...
![Supabase](https://img.shields.io/badge/Supabase-%2300B55B.svg?style=for-the-badge\&logo=supabase\&logoColor=white)
